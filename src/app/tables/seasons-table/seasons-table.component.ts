...
@Component ({
               ...
               styleUrl:    './seasons-table.component.css'
            })
export class SeasonsTableComponent implements OnInit
{
   ...
   constructor (public router: Router,
                ...
                public theDataService: SeasonsService,
   ...
   {
      this.isLoading = true;
      this.theDataService.getAllData (null).subscribe (data =>
                                                   {
                                                      if (data)
                                                      {
                                                         if (data.ok)
   ...
   onAdd (): void
   {
      this.router.navigate ([`/seasonedit`], {state: {id: 0}});
   }


   onEdit (item: any): void
   {
      this.router.navigate ([`/seasonedit`], {state: {id: item.id}});
   }
   ...
   {
      const dlgData: MessDlgData = {
         title:               'Cancellazione Stagione',
         subtitle:            '',
         message:             `Sei veramente sicuro di voloer cancellare la stagione '<b>${item.nome}</b>' dal database?`,
         messtype:            'warning',
         btncaption:          'Annulla',
